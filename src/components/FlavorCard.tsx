      ...
      >
        {!hideCan && (
          <img
            ...
            loading="lazy"
            className="h-full max-h-[280px] w-auto max-w-none object-contain drop-shadow-[0_25px_35px_rgba(0,0,0,0.6)] transition-transform duration-500 group-hover:scale-105 group-hover:-rotate-3"
          />
        )}
      </div>
